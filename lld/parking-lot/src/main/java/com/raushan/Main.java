...
import com.raushan.strategy.fee.VehicleBaseFeeStrategy;
import com.raushan.vehicle.Bike;
import com.raushan.vehicle.Car;
import com.raushan.vehicle.Truck;
...
public class Main {
    public static void main(String[] args) {
        ...
        floor1.addSpot(new ParkingSpot("F1-M1", VehicleSize.REGULAR));
        floor1.addSpot(new ParkingSpot("F1-L1", VehicleSize.LARGE));

        ParkingFloor floor2 = new ParkingFloor(2);
        floor2.addSpot(new ParkingSpot("F2-M1", VehicleSize.REGULAR));
        floor2.addSpot(new ParkingSpot("F2-M2", VehicleSize.REGULAR));

        parkingLot.addFloor(floor1);
        parkingLot.addFloor(floor2);

        parkingLot.setFeeStrategy(new VehicleBaseFeeStrategy());
